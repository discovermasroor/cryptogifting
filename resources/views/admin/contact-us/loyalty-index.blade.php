@include('admin.head')
    <title>Loyalty Program Submissions | Dashboard</title>
    <body>
        @include('admin.header-sidebar')
            <!-- Main Content Starts -->
            <div class="main-content">
                <div class="overlay">
                    <form action="{{route('LoyaltyAdmin')}}" method="get">
                        ...
                        <div class="main-heading-box flex">
                            <h3>Loyalty Program Form Submission</h3>
                            <div class="filters mt-0">
                                ...
                                <a href="{{route('LoyaltyAdmin')}}" class="btn submit-button">Clear</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($contact_us as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><a href="{{route('LoyaltyProgramInfoAdmin', [$value->contact_us_id])}}" class="btn edit-button">View</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
