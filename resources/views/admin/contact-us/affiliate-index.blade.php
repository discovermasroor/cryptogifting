@include('admin.head')
    <title>All Affiliates Submissions | Dashboard</title>
    <body>
        @include('admin.header-sidebar')
            <!-- Main Content Starts -->
            <div class="main-content">
                <div class="overlay">
                    <form action="{{route('AffiliatesAdmin')}}" method="get">
                        ...
                        <div class="main-heading-box flex">
                            <h3>Affiliates Form Submission</h3>
                            <div class="filters mt-0">
                                ...
                                <a href="{{route('AffiliatesAdmin')}}" class="btn submit-button">Clear</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($contact_us as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><a href="{{route('AffiliateInfoAdmin', [$value->contact_us_id])}}" class="btn edit-button">View</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
