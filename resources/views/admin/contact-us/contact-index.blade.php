@include('admin.head')
    <title>All Contact Us Submissions | Dashboard</title>
    <body>
        @include('admin.header-sidebar')
            ...
            <div class="main-content">
                <div class="overlay">
                    ...
                    <form action="{{route('ContactUsAdmin')}}" method="get">
                        ...
                        <div class="main-heading-box flex">
                            ...
                            <div class="filters mt-0">
                                ...
                                <a href="{{route('ContactUsAdmin')}}" class="btn submit-button">Clear</a>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    <?php foreach ($contact_us as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <?php } ?>
                                            <td><a href="{{route('ContactUsInfoAdmin', [$value->contact_us_id])}}" class="btn edit-button">View</a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
