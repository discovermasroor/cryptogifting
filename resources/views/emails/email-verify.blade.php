                                ...
                                <tbody
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p class="my-0" style="margin-top:0 !important;color:#242021;font-size:14px;font-weight:400;">You requested to sign up with CryptoGifting.</p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p class="my-0" style="margin-top:0 !important;color:#242021;font-size:14px;font-weight:400;">Before we can lift you off to the world of CryptoGifting, please <a href="{{route('VerifyEmail', [$user->email_verification_code])}}" class="web-link"
                                                    style="font-weight:700;color:#1947A1 !important;">click here</a> to confirm your email address. Why? So we know it's really you..</p>
                                        </td>
                                    </tr>  
                                    <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
