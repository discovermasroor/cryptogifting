                                    ...
                                    <tbody
                                        ...
                                        <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                                <p class="my-0" style="margin-top:0 !important;color:#242021;font-size:14px;font-weight:400;">You have successfully changed your bank account details on your <br> CryptoGifting.com account where you receive your withdrawals. <br>If you are not 100% sure that you have provided us with the correct bank details, <br> please log into your profile to double check.</p>
                                            </td>
                                        </tr>
