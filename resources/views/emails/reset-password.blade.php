                                ...
                                <tbody
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="person-title" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <?php if (!empty($user->first_name) && !empty($user->last_name)) { ?>
                                                <h3 style="color:#242021;font-weight:600;">Hi <span class="name">Dear: {{$user->first_name}} {{$user->last_name}}</span>

                                            <?php } else { ?>
                                                <h3 style="color:#242021;font-weight:600;">Hi <span class="name">Dear: {{$user->username}}</span>
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p class="my-0" style="margin-top:0 !important;color:#242021;font-size:14px;font-weight:400;">You requested to change your CryptoGifting password</p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p class="my-0" style="margin-top:0 !important; color:#242021;font-size:14px;font-weight:400;">If you do not want to change your password, you can simply ignore this email</p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p class="my-0" style="margin-top:0 !important; color:#242021;font-size:14px;font-weight:400;">Otherwise, <a href="{{route('ResetPassword', [$user->reset_password_token])}}"
                                                    style="font-weight:700;color:#1947A1 !important;">Click Here</a> to reset your password.</p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                        ...
                                        <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                                <p class="my-0" style="margin-top:0 !important; color:#242021;font-size:14px;font-weight:400;">Questions? Learn more about   <a href="{{route('ContactUs')}}">about securing your account. </a></p>
                                            </td>
                                        </tr>
                                </tbody>
                            </table>
