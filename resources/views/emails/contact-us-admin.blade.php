...
<?php
    if ($contact_us->contact_us) {
        ...
        $message = 'Someone just fillup the feedback form on our website!';
                                ...
                                <tbody
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">We would like to inform you that we have received your message that was submitted on the “Contact Us” page and one of our agents will be getting back to you shortly</p>
                                        </td>
                                    </tr>

                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">Our customers come first and we will ensure that you receive the highest level of service possible.</p>
                                        </td>
                                    </tr>
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">Please feel free to start sharing our platform with friends and family through all of our favourite communication channels including email, WhatsApp and Facebook.</p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
