                                ...
                                <tbody
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="person-title" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <h3 style="color:#242021;font-weight:600;">Hello <span class="name">{{ucfirst($gift_info->sender_name)}}</span>
                                            </h3>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">You have successfully sent BTC {{number_format($gift_info->gift_btc_amount, 10)}} from {{ucfirst($gift_info->recipient_name)}} with CryptoGifting.com and your Theme Card is attached to this email.
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p class="my-0" style="margin-top:0 !important; color:#242021;font-size:14px;font-weight:400;">
                                             Now that you have the hand of it,<a href="{{route('RegisterGiftUser', [$gift_info->sender_id])}}" class="web-link" style="font-weight:700;color:#1947A1 !important;">Click here</a> to sign up for your own CryptoGifting account and Create an Event which you can share with friends and family in order receive cryptocurrencies for your special occasions. </p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                        ...
                                        <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                                <p class="my-0" style="margin-top:0 !important; color:#242021;font-size:14px;font-weight:400;"><a href="{{route('ContactUs')}}">Click here </a> to let us know if your email address is used without your consent.</p>
                                            </td>
                                        </tr>
                                        <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                        ...
                                        <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                                <p class="my-0" style="margin-top:0 !important; color:#242021;font-size:14px;font-weight:400;">Questions? Visit our  <a href="{{route('ContactUs')}}">Help Centre. </a></p>
                                            </td>
                                        </tr>
                                </tbody>
                            </table>
