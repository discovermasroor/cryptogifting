                                ...
                                <tbody
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="person-title" style="min-width:100%;padding:0;padding:0px 70px;">
                                            ...
                                            <?php } else { ?>
                                                <h3 style="color:#242021;font-weight:600;">Hi <span class="name">Dear: {{$user->first_name}}</span>
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">Congratulations! You have added beneficiary in our CG plateform, kindly click on this 
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
