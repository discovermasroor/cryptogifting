                                ...
                                <tbody
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">We would like to inform you that we have received your email and that one of our customer care agents will get in touch with you..</p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">At CryptoGitfing.com, we are constantly looking for new and innovative ways to collaborate with like-minded individuals and companies who can assist us in growing our vision!</p>
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
