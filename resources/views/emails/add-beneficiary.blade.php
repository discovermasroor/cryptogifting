                                ...
                                <tbody
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="person-title" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <?php if (!empty($beneficiary->name) && !empty($beneficiary->surname)) { ?>
                                                <h3 style="color:#242021;font-weight:600;">Hello <span class="name">Dear: {{$beneficiary->name}} {{$beneficiary->surname}}</span>

                                            <?php } else { ?>
                                                <h3 style="color:#242021;font-weight:600;">Hello <span class="name">Dear: {{$beneficiary->name}}</span>
                                    ...
                                    <tr style="min-width:100% !important;">
                                        <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                            <p style="color:#242021;font-size:14px;font-weight:400;">Your beneficiary “{{$beneficiary->name}} {{$beneficiary->surname}} ({{$beneficiary->email}})” has been successfully created on your CryptoGifting.com profile.
                                        </td>
                                    </tr>
                                    <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
