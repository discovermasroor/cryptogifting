                                    ...
                                    <tbody
                                        ...
                                        <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                                <p class="my-0" style="margin-top:0 !important;color:#242021;font-size:14px;font-weight:400;">Your KYC verification with CryptoGifting.com has been successful.</p>
                                            </td>
                                        </tr>
                                        <tr style="min-width:100% !important;">
                                            <td class="signin-pin" style="min-width:100%;padding:0;padding:0px 70px;">
                                                <p class="my-0" style="margin-top:0 !important;color:#242021;font-size:14px;font-weight:400;"><a href="{{route('SignIn')}}">Click here </a> to log into your profile and create your next event or view and manage the performance of previous events.</p>
                                            </td>
                                        </tr>
