@include('head')
    <title>Send a Gift to {{ get_user_name($event->creator_id) }} | CryptoGifting.com</title>
    <style>
        body{
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="sec_hd">
                                ...
                                <small class="mt-0 mt-md-2">Transaction Fees are calculated on checkout</small>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form id="gift-form" action="{{route('StoreEventInvitation', [$event->event_id])}}" method="post" class="gift-form form-style">
                                ...
                                <div class="flow_2">
                                    ...
                                    <div class="flow_inner">
                                        ...
                                        <div class="checkboxes mt-2 mt-sm-3">
                                            <div class="form-check form-check-inline text-white">
                                                <input class="form-check-input gift-type" type="radio" name="gift_type" id="gift-allocation1"
                                                    value="own_gift">
                                                <label class="form-check-label" for="gift-allocation1">I will give my own gift</label>
                                            </div>
                                            <div class="form-check form-check-inline text-white">
                                                <input class="form-check-input gift-type" type="radio" name="gift_type" id="gift-allocation2"
                                                    value="no_gift">
                                                <label class="form-check-label" for="gift-allocation2">I will give no gift</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            jQuery(document).ready(function ($) {
                ...
                $('#pay-now').on('click', function(e) {
                    if (!$("#gift-allocation1").prop("checked") && !$("#gift-allocation2").prop("checked")) {
                        ...
                        $.ajax({
                            url: '{{route("GiftAmountDashboard22")}}',
                            type: 'POST',
                            data: formData,
                            dataType: 'JSON',
