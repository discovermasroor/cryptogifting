    ...
    <div id="preloader" class="d-none"></div>
        @include('user-dashboard.user-dashboard-header')
            ...
            <div class="main-content withdraw-page">
                <div class="overlay">
                    <h1 class="main-heading">Edit Single Contact</h1>
                    <form action="{{route('UpdateContact', [$contact->contact_id])}}" method="POST" class="form-style add-beneficiary-form edit-form">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="hidden" name="relation" id="relation" value="{{$contact->relation}}">
                        <div class="row">

                            <div class="col-md-6">
                                <label for="name" class="form-label">Name *</label>
                                <input type="text" class="form-control" id="name" placeholder="Name *" value="{{$contact->name}}" name="name" required>
                            </div>

                            <div class="col-md-6">
                                <label for="surname" class="form-label">Surname </label>
                                <input type="text" class="form-control" id="surname" placeholder="Surname *" name="surname" value="{{$contact->surname}}">
                            </div>

                            <div class="col-md-6">
                                <label for="emailAddress" class="form-label">Email Address *</label>
                                <input type="email" value="{{$contact->email}}" disabled class="form-control" id="emailAddress" placeholder="Email Address *" required>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Date of Birth</label>
                                <div class="input-group input-calander">
                                    <input type="text" data-toggle="datepicker" placeholder="Date of Birth" value="{{$contact->dob}}" class="form-control input-date" id="event_date" name="dob">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="options-container">
                                    ...
                                    <div class="selected"> {{ucfirst($contact->relation)}} </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-center">
                                <div class="two-button-box mx-auto" style="width: 100%; max-width: 450px;">
                                    ...
                                    <button type="submit" class="btn blue-button mt-0">Update Contact</button>
                                </div>
                            </div>
